...
export type NewsletterHmacConfig = { secret: string; keyId: string; origin: string };
export function signNewsletterRequest(input:{path:string;rawBody:string},config:NewsletterHmacConfig,options:{timestamp?:string;nonce?:string}={}) {
