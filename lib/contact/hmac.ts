...
export type ContactHmacConfig = { secret: string; keyId: string; origin: string };
export function signContactRequest(input:{path:string;rawBody:string},config:ContactHmacConfig,options:{timestamp?:string;nonce?:string}={}) {
