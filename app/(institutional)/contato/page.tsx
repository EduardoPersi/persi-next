  ...
  return (
    <>
      ...
      <main className="py-6 sm:py-8 lg:py-10">
        <Container size="lg">
          <h1 className="text-center text-2xl font-bold text-[#ff6a00] sm:text-3xl">
          ...
          <div className="mt-8 grid gap-10 lg:grid-cols-2">
            <div>
              ...
              <p className="mt-3 flex items-start gap-3 text-sm text-slate-600">
                <MapPin
                  aria-hidden="true"
              ...
              <a
                ...
                className="tap-feedback mt-2 flex min-h-9 items-center gap-3 rounded-md text-sm text-slate-600 transition-colors hover:text-[#ff6a00]"
              >
                <WhatsAppIcon
                  aria-hidden="true"
                  className="h-5 w-5 shrink-0 text-[#0c2d72]"
                />
          ...
          <div className="mt-10">
            <h2 className="text-lg font-bold text-[#ff6a00]">
