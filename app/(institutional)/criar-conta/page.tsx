...
export default function RegisterPage(){return <InstitutionalPageLayout title="Criar conta" accountSession={{authenticated:false}}><div className="mx-auto max-w-md"><p className="mb-6 text-muted">Crie sua conta para acompanhar seus pedidos com segurança.</p><AccountRegisterForm/><div className="mt-6"><SocialLoginButtons descriptionId="register-social-login-status"/><p id="register-social-login-status" className="mt-2 text-center text-xs text-muted">Use Google ou Facebook para criar ou vincular sua conta.</p></div></div></InstitutionalPageLayout>;}
