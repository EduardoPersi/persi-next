...
export default async function Page(){const session=await getServerAccountSession();if(!session)redirect("/entrar");return <CustomerWorkspacePage title="Produtos vistos" session={session}><p className="text-slate-600">Os últimos produtos visualizados neste dispositivo.</p><RecentlyViewedProducts title="Visualizados recentemente" sectionId="workspace-viewed-products" showEmptyState/></CustomerWorkspacePage>}
