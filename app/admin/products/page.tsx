...
export default async function AdminProductsPage({searchParams}:{searchParams:SearchParams}){
  ...
  return <>
    ...
    <form className="mb-5 grid gap-3 rounded-xl border bg-white p-4 md:grid-cols-4 xl:grid-cols-8">
      ...
      <label>Sugestões<select name="suggestions" defaultValue={filters.suggestions} className="mt-1 w-full rounded-xl border px-3 py-2"><option value="">Todas</option><option value="with">Com sugestões</option><option value="without">Sem sugestões</option></select></label>
