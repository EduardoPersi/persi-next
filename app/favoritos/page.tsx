...
export default function FavoritesPage(){return <><Header/><main className="py-6 sm:py-10"><Container><nav aria-label="Breadcrumb" className="text-sm text-slate-600"><Link href="/" className="hover:text-[#ff6a00]">Home</Link><span aria-hidden="true" className="mx-2">›</span><span aria-current="page">Favoritos</span></nav><h1 className="mt-5 text-2xl font-bold text-[#071f5c] sm:text-3xl">Meus favoritos</h1><div className="mt-6"><FavoritesPageClient/></div></Container></main></>}
