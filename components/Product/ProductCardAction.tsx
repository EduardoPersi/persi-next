    ...
    if (!available) {
      return (
        <div className="mt-3">
          <Link
            href={href}
            className="inline-flex h-10 w-full items-center justify-center rounded-[6px] bg-slate-600 px-3 text-center text-base font-medium uppercase text-white transition-colors hover:bg-slate-700 active:bg-slate-800 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-slate-600 focus-visible:ring-offset-2 md:text-sm"
          >
            Avise-me
          </Link>
  ...
  return (
    <div className="mt-3">
      <button
        ...
        onClick={handleAdd}
        disabled={isAdding}
        className="inline-flex h-10 w-full items-center justify-center rounded-[6px] bg-[#ff6a00] px-2 py-1 text-center text-[10px] font-medium leading-[13px] text-white transition-colors hover:bg-[#e85f00] active:bg-[#cc5200] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#ff6a00] focus-visible:ring-offset-2 disabled:cursor-wait disabled:opacity-60 lg:px-3 lg:py-2 lg:text-sm lg:leading-4"
      >
        {isAdding ? (
          "Adicionando..."
        ) : (
