          ...
          {status === "loading" ? (
            ...
            <div className="space-y-5">
              <div className="rounded-xl border border-slate-200 bg-slate-50 p-4">
                <p className="font-semibold text-[#071f5c]">
              ...
              <Link
                href="/minha-conta"
                onClick={onClose}
                className="flex min-h-11 items-center justify-center rounded-xl bg-[#0c2d72] px-4 py-2 font-medium text-white hover:bg-[#071f5c]"
              >
                Acessar minha conta
              </Link>
              <Button
