...
class Persi_Headless_Newsletter_Repository {
	public static function table() {
		global $wpdb;
		return $wpdb->prefix . 'persi_newsletter_subscribers';
	}
	public static function nonce_table() { global $wpdb; return $wpdb->prefix . 'persi_newsletter_nonces'; }
	...
	public static function cleanup_nonces() {
		global $wpdb;
		$wpdb->query( $wpdb->prepare( 'DELETE FROM ' . self::nonce_table() . ' WHERE expires_at <= %s', current_time( 'mysql', true ) ) );
	}
