...
final class Persi_Headless_Stock_Configuration {
	const REST_PATH = '/wp-json/persi/v1/stock-notifications/subscribe';
	...
	public static function secret() { return self::value( 'PERSI_HEADLESS_STOCK_HMAC_SECRET' ); }
	public static function key_id() { $value = self::value( 'PERSI_HEADLESS_STOCK_HMAC_KEY_ID' ); return preg_match( '/^[A-Za-z0-9._-]{1,40}$/', $value ) ? $value : 'primary'; }
	public static function origins() {
		$value = self::value( 'PERSI_HEADLESS_STOCK_ALLOWED_ORIGINS' );
	...
	public static function trusted_proxy_ips() {
		$value = self::value( 'PERSI_HEADLESS_STOCK_TRUSTED_PROXY_IPS' );
	...
	public static function frontend_url() {
		$value = self::value( 'PERSI_HEADLESS_STOCK_FRONTEND_URL' );
